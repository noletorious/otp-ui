...
export function getPlaceName(place) {
  ...
  var network = ((_place$networks = place.networks) === null || _place$networks === void 0 ? void 0 : _place$networks[0]) || (place === null || place === void 0 || (_place$rentalVehicle = place.rentalVehicle) === null || _place$rentalVehicle === void 0 ? void 0 : _place$rentalVehicle.network);
  var company = network && getCompanyForNetwork(network, companies);
  if (intl && (
